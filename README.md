...
![home](http://oe9d5k8dj.bkt.clouddn.com/home.png)<i class="icon-pencil"></i> 主页;
...
![home](http://oe9d5k8dj.bkt.clouddn.com/home.png)<i class="icon-pencil"></i>base类型;

#### 柱图`bar_v`,`bar`

![bar](http://oe9d5k8dj.bkt.clouddn.com/bar_v.png)<i class="icon-pencil"></i>bar类型 ;

#### 折线图`polyline`

![polyline](http://oe9d5k8dj.bkt.clouddn.com/polyline.png)<i class="icon-pencil"></i> polyline类型;

#### 雷达图`radar`

![radar](http://oe9d5k8dj.bkt.clouddn.com/radar.png)<i class="icon-pencil"></i> radar类型;

#### 环图`ring`

![ring](http://oe9d5k8dj.bkt.clouddn.com/ring.png)<i class="icon-pencil"></i> ring类型;

#### 点图`point`

![point](http://oe9d5k8dj.bkt.clouddn.com/point.png)<i class="icon-pencil"></i> point类型;
